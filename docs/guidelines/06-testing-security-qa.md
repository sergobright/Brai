...
| `deploy/scripts/complete-operation-activities.sh <operation:agent-task:id>` | `require_escalated` | Helper re-enters the host deploy context and writes the protected runtime Postgres DB. |
