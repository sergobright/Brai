...
- Док-меню — существующий нижний `MainDock` и центральная основная навигация: `Брай`, `Действия`, `Inbox`, `Фокус`, `Factory`, `Draws`; на mobile `Draws` остаётся в overflow.
...
- Дроп-меню — меню аватара на desktop и три точки слева на mobile; Контекст-меню — крайняя узкая desktop-панель и мобильная сетка 3×4.
