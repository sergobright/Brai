...
Brai is a local-first productivity application for actions, focus sessions, history, goals, settings, and self-hosted Android/web delivery.

The product ships through:

- a Next.js/React web client;
- a Capacitor Android shell;
- a Node.js Brai API backed by Supabase Postgres;
