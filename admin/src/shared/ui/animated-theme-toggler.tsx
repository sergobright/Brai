...
export const AnimatedThemeToggler = ({
  ...
  useEffect(() => {
    ...
    const updateTheme = () => {
      setInternalIsDark(document.documentElement.dataset.theme === "dark" || document.documentElement.classList.contains("dark"))
    }
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      // Always set the theme synchronously so the View Transitions API
      ...
      if (isControlled) {
        ...
        localStorage.setItem("brai_theme_mode", nextTheme)
      }
    }
