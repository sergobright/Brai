...
/**
 * Defines the IndexedDB schema used by the Bright OS offline-first client.
 */
...
let dbInstance: BrightOsClientDb | null = null;

export function clientDb(): BrightOsClientDb {
  dbInstance ??= new BrightOsClientDb();
  return dbInstance;
}
