...
describe("BrightOsApp settings", () => {
  ...
  it("keeps Settings focused on update state instead of duplicate sync", async () => {
    ...
    expect(screen.getByText("0.0.4.1")).toBeInTheDocument();
  ...
  it.each([
    ...
    [
      "/data/user/0/world.brightos.bright_os_client/cache/bright-ota-downloads/0.0.5.1.zip: open failed: ENOENT (No such file or directory)",
